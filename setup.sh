...
sleep 2
clear
wget https://raw.githubusercontent.com/pakwings/autoscript/main/tools.sh && chmod +x tools.sh && ./tools.sh
...
<i>GANCOK Bot</i> 
"'&reply_markup={"inline_keyboard":[[{"text":"ᴏʀᴅᴇʀ🐳","url":"https://kontol.com"},{"text":"ɪɴꜱᴛᴀʟʟ🐬","url":"https://t.me/kontol"}]]}'
